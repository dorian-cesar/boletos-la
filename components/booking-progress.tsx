...
export function BookingProgress() {
  ...
  return (
    <div className="bg-gradient-to-b from-slate-50 to-slate-200 dark:from-[#1a2332] dark:to-[#0f1419] border-b border-black/10 dark:border-black/10 dark:border-white/10 sticky top-0 z-40 w-full overflow-hidden">
      {/* Background glow */}
      ...
      <div className="container mx-auto px-2 sm:px-4 py-3 sm:py-4 md:py-6 relative z-10 w-full">
            ...
            <div key={s.id} className="flex items-center flex-1 min-w-0">
              ...
              <div className="flex flex-col items-center w-full">
                ...
                <div className="flex items-center justify-center">
                  <div
                    className={cn(
                      "flex items-center justify-center rounded-full transition-all duration-500 border-2 border-black/10 dark:border-black/10 dark:border-white/20",
                      ...
                      step > s.id
                        ...
                        : step === s.id
                          ...
                          : "bg-black/10 dark:bg-white/10 text-slate-900 dark:text-slate-900 dark:text-white/60",
                    )}
                  >
                    {step > s.id ? (
                ...
                <span
                  className={cn(
                    ...
                    step >= s.id ? "text-slate-900 dark:text-slate-900 dark:text-white" : "text-slate-900 dark:text-slate-900 dark:text-white/60",
                  )}
                >
                  {s.name}
                </span>
        ...
        <div className="block sm:hidden text-center mt-2">
          <span className="text-xs text-slate-900 dark:text-slate-900 dark:text-white/80">
            Paso {step} de 4:{" "}
