...
const countryDestinations: Record<string, { name: string; image: string; available?: boolean }[]> = {
  ...
  brasil: [
    ...
    { name: "RIO DE JANEIRO / BÚZIOS", image: "/images/destinations/brasil-buzios.jpg" },
  ...
  colombia: [
    ...
    { name: "CARTAGENA / CÚCUTA", image: "/images/destinations/colombia-cucuta.jpg" },
  ...
  chile: [
    ...
    { name: "PUERTO MONTT / BARILOCHE", image: "/images/destinations/chile-puerto-montt.jpg" }
  ],
  paraguay: [
...
const locationCodes: Record<string, string> = {
  ...
  "SÃO PAULO": "BRSAO", "RIO DE JANEIRO": "BRRIO", "BELO HORIZONTE": "BRBHZ", "BÚZIOS": "BRBZI",
  ...
  "PUERTO MONTT": "CLPMC", "TEMUCO": "CLZCO", "MENDOZA": "ARMDQ", "ANTOFAGASTA": "CLANF",
