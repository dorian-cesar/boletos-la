            ...
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-4">
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label="WhatsApp"
                  className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#00c7cc] hover:text-[#1a2332] fill-current text-white transition-all duration-300 hover:scale-110"
                >
