      ...
      <div className="p-6 sm:p-8 min-h-[250px] flex flex-col justify-center relative">
        {isLoading ? (
          <div className="flex flex-col items-center justify-center py-8">
            ...
            <h3 className="text-lg sm:text-xl font-semibold text-slate-900 dark:text-white mb-2">Buscando alternativas...</h3>
          ...
          <div className="flex flex-col items-center justify-center py-8 animate-in fade-in duration-500">
            ...
            <h3 className="text-xl font-semibold text-slate-900 dark:text-white mb-2 text-center">No hay alternativas cercanas</h3>
