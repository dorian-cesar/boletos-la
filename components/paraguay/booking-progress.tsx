...
export function BookingProgress() {
  ...
  return (
    <div className="bg-gradient-to-b from-slate-50 to-slate-200 dark:from-[#1a2332] dark:to-[#0f1419] border-b border-black/10 dark:border-black/10 dark:border-white/10 relative z-30 w-full overflow-hidden">
      {/* Background glow */}
