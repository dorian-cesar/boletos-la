    ...
    <div className="bg-black/5 dark:bg-white/5 backdrop-blur-sm rounded-2xl p-4 md:p-6 shadow-lg border border-black/10 dark:border-black/10 dark:border-white/20">
      ...
      <div className="flex flex-wrap items-center justify-center gap-4 md:gap-6 mb-8">
        ...
        <div className="flex items-center gap-1.5 md:gap-2">
          ...
          <span className="text-xs md:text-sm text-slate-900 dark:text-slate-900 dark:text-white/60">VIP</span>
        </div>
        <div className="flex items-center gap-1.5 md:gap-2">
          <Star className="h-3.5 w-3.5 md:h-5 md:w-5 text-primary" />
          <span className="text-xs md:text-sm text-slate-900 dark:text-slate-900 dark:text-white/60">Cama</span>
        </div>
        <div className="flex items-center gap-1.5 md:gap-2">
          <div className="w-4 h-4 md:w-6 md:h-6 rounded bg-black/20 dark:bg-white/20 border border-background/40" />
          <span className="text-xs md:text-sm text-slate-900 dark:text-slate-900 dark:text-white/60">Semi</span>
        </div>
      </div>
      ...
      <div className="mt-8 p-4 bg-black/10 dark:bg-white/10 rounded-xl border border-black/10 dark:border-black/10 dark:border-white/20">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p
              className={cn(
                "font-bold text-2xl text-slate-900 dark:text-slate-900 dark:text-white transition-colors duration-300",
                currentSelectedSeats.length > 4
